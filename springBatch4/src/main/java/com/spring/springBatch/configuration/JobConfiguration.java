...
import com.spring.springBatch.components.CustomRetryableException;
import com.spring.springBatch.components.RetryItemProcessor;
import com.spring.springBatch.components.RetryItemWriter;
...
public class JobConfiguration {
	...
	@Bean
	public Step step1() {
		return stepBuilderFactory.get("step31")
